...
typedef struct process_logs {
	list_t my_ptr;
	forbidden_activity_info my_frobidden_activities;
} processLogs;
...
/* HW1 */
	int policyFeature; /* 1 for ON and 0 for OFF */
	int privilegeLevel;
	list_t frobiddenActivities;
	int numOffrobiddenActivities;
};
...
{									\
	...
	policyFeature:			0,						\
	privilegeLevel:			2,							\
	frobiddenActivities:	LIST_HEAD_INIT(tsk.frobiddenActivities), 		\
	numOffrobiddenActivities:	0, 										\
}
